...
void ImGui::ImageRounded( ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& tint_col, float round )
{
    ImGuiWindow* window = GetCurrentWindow( );
    if ( window->SkipItems )
        return;
    ...
    if ( !ItemAdd( bb, 0 ) )
        ...
        window->DrawList->AddImageRounded( user_texture_id, bb.Min, bb.Max,
                                           uv0, uv1, GetColorU32( tint_col ), round );    
}
void ImGui::ImagePos( ImTextureID user_texture_id, const ImVec2& pos, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& tint_col )
{
    ImGuiWindow* window = GetCurrentWindow( );
    //if ( window->SkipItems )
    //    return;
